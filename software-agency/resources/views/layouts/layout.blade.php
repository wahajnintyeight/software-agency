...
<body class="bg-slate-900">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <header class="flex justify-between items-center py-4 md:py-8">
            <!-- logo - start -->
            <a href="/" class="inline-flex items-center text-white text-2xl md:text-3xl font-bold gap-2.5"
                aria-label="logo">
            ...
            <nav class="hidden lg:flex gap-12">
                <a href="{{route('/')}}"
                    class="text-white hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">Home</a>

                <a href="#"
                    class="text-white hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">Pricing</a>
                <a href="{{route('about')}}"
                    class="text-white hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">About</a>
                <a href="{{ route('team') }}"
                    class="text-white hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">Our
                    Team</a>
                <a href="#"
                    class="text-white hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100">Contact
                    Us</a>
            </nav>
            <!-- nav - end -->
                    ...
                    <div>
                        <div class="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
                            ...
                            <div class="col-span-2 sm:col-span-3 md:col-span-2">
                                ...
                                <ul class="mt-4 list-inside space-y-4">
                                    <li>
                                        <a href="tel:+243996660436" class="transition hover:text-primary">+243 996 660
                                            436</a>
                                    </li>
                                    <li>
                                        <a href="mailto:meschacirung@gmail.com"
                                            class="transition hover:text-primary">contact@tailus.com</a>
                                    </li>
                                    <li>
                                        <form action="">
                                            <label for="newsletter"
                                                class="text-lg text-gray-700 dark:text-gray-200">Subscribe to our
                                                newsletter</label>
                                            <div class="relative mt-4">
                                                <input type="email" name="newsletter" id="newsletter"
                                                    placeholder="Your email"
                                                    class="invalid:outline-none placeholder-white dark:placeholder-white rounded-3xl w-full bg-gray-100 dark:bg-gray-900 px-4 py-3 ring-1 ring-gray-200 dark:ring-gray-700 invalid:ring-red-400" />
