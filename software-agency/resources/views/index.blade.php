...
@section('content')
    <div class="bg-slate-900 relative pt-20 pb-20 lg:pt-24">
        <div class="relative xl:container m-auto px-6 md:px-12 lg:px-6">
            <section class="flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16 mb-8 md:mb-16">
                <!-- content - start -->
                <div class="xl:w-5/12 flex flex-col justify-center sm:text-center lg:text-left lg:py-12">
                    ...
                    <h1 class="text-white text-4xl sm:text-5xl md:text-6xl font-bold mb-8 md:mb-12">Revolutionary way to
                        build the web</h1>
            ...
            <div class="bg-slate-900 py-6 sm:py-8 lg:py-12">
                <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    <h2 class="text-white text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-8">Trusted by the best
                    </h2>

                    <div
                        class="sm:h-40 grid grid-cols-2 md:grid-cols-4 sm:content-evenly bg-indigo-500 rounded-lg gap-6 p-6">
                        <!-- logo - start -->
                        <div class="flex justify-center text-gray-400">
                            <svg class="w-auto h-6 sm:h-8 lg:h-10" width="154" height="39" viewBox="0 0 154 39"
                        ...
                        <!-- logo - start -->
                        <div class="flex justify-center text-gray-400">
                            <svg class="w-auto h-6 sm:h-8 lg:h-10" width="186" height="39" viewBox="0 0 186 39"
                                fill="white" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- logo - start -->
                        <div class="flex justify-center text-gray-400">
                            <svg class="w-auto h-6 sm:h-8 lg:h-10" width="173" height="39" viewBox="0 0 173 39"
                                fill="white" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <!-- logo - start -->
                        <div class="flex justify-center text-gray-400">
                            <svg class="w-auto h-6 sm:h-8 lg:h-10" width="146" height="39" viewBox="0 0 146 39"
                                fill="white" xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="py-6 sm:py-8 lg:py-12">
                    <div class="max-w-screen-lg px-4 md:px-8 mx-auto">
                        ...
                        <div class="mb-8 md:mb-12">
                            <h2 class="text-white text-2xl lg:text-3xl font-bold text-center white-200 mb-4 md:mb-6">Our
                                Team by
                                the numbers</h2>
            ...
            <section>
                <div class="py-6 sm:py-8 lg:py-12">
                    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                        <h2 class="text-white text-2xl lg:text-3xl font-bold text-center mb-8 md:mb-12">Our Team</h2>
            ...
            <section>
                <div class="relative py-16">
                    <div class="container relative m-auto px-6 text-gray-500 md:px-12">
                        <div class="grid md:mx-auto  lg:w-full mb-10">

                            <h2 class="text-white text-2xl lg:text-3xl font-bold text-center mb-2 md:mb-12">Our Services
                            </h2>
                        </div>
                        <div class="grid gap-6 md:mx-auto md:w-8/12 lg:w-full lg:grid-cols-3">
                            ...
                            <div
                                ...
                                <img class="mx-auto w-30" style="width:265px" src="{{ asset('images/web.svg') }}"
                            ...
                            <div
                                class="group space-y-6 border border-gray-100 dark:border-gray-700 rounded-3xl bg-white dark:bg-gray-800 px-8 py-12 text-center shadow-2xl shadow-gray-600/10 dark:shadow-none">
                                <img class="mx-auto w-20" style="width:180px" src="{{ asset('images/service3.svg') }}"
                                    alt="illustration" loading="lazy" />
                                <h3 class="text-2xl font-semibold text-gray-800 dark:text-white">Mobile Developement</h3>
                                <p>
                                    Obcaecati, quam? Eligendi, nulla numquam natus laborum porro at cum, consectetur ullam
                                    tempora ipsa iste officia sed officiis! Incidunt ea animi officiis.
                                </p>
                            ...
                            <div
                                class="group space-y-6 border border-gray-100 dark:border-gray-700 rounded-3xl bg-white dark:bg-gray-800 px-8 py-12 text-center shadow-2xl shadow-gray-600/10 dark:shadow-none">
                                <img class="mx-auto w-30" style="width:364px" src="{{ asset('images/service4.svg') }}"
                                    alt="illustration" loading="lazy" />
                    ...
                    <div class="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
                        <div
                            ...
                            <div class="flex h-full flex-col justify-center space-y-4">
                                <img class="mx-auto h-28 w-28 rounded-full" src="{{ asset('images/team1.svg') }}"
                                    alt="user avatar" height="350" width="350" loading="lazy" />
                                <p class="md:text-xl">
                        ...
                        <div
                            class="rounded-3xl sm:flex sm:space-x-8 border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-8 text-center shadow-2xl shadow-gray-600/10 dark:shadow-none">
                            <img class="mx-auto h-28 w-28 rounded-full" src="{{ asset('images/team1.svg') }}"
                                alt="user avatar" height="350" width="350" loading="lazy" />
